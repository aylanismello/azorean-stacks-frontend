  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="w-8 h-8 rounded-full bg-surface-2 border border-surface-3 flex items-center justify-center text-xs font-medium text-muted hover:text-white hover:border-accent/40 transition-all"
        title="Account"
      >
        {initial}
      </button>
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-56 bg-surface-1 border border-surface-3 rounded-xl shadow-2xl shadow-black/60 overflow-hidden z-50">
          {/* User info */}
          ...
          <div className="px-2 py-2 border-b border-surface-2">
            {spotify.connected ? (
              ...
              <button
                ...
                className="w-full flex items-center gap-2 px-2 py-1.5 rounded-lg text-sm text-white/80 hover:bg-surface-2 transition-colors"
              >

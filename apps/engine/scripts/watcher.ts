...
const CONCURRENCY = {
  enrich: 3,          // Spotify + YouTube lookups per batch (low to respect Spotify rate limits)
...
const PRIORITY_ENRICH_CONCURRENCY = 3;    // Max concurrent enrichments (Spotify rate limit safe)
